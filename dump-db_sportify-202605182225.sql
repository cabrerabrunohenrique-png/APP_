...
--
-- Host: localhost    Database: db_sportify
-- ------------------------------------------------------
...
CREATE TABLE `tb_discografia` (
  `idDiscografia` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping routines for database 'db_sportify'
--
...
-- Dump completed on 2026-05-18 22:25:16
